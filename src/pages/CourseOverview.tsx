  ...
  return (
    <section className="course-overview wrap">
      <div className="course-overview-main">
        ...
        <h1 data-armature-page-title="">{copy.text("main", "title")}</h1>
...
armature.registerSiteSection("course-detail", { label: "Course overview", component: CourseDetail });

export default function CourseOverview() {
  return (
    <main>
      <SiteHeader activePath="/events/location/" />
      <ArmatureSlot slug="course-overview" defaults={["course-detail"]} />
      <SiteFooter />
    </main>
  );
}
