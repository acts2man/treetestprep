...
armature.registerSiteSection("exam-hero", { label: "Exam hero", component: ExamHero });
armature.registerSiteSection("exam-content", { label: "Exam information", component: ExamContent });

export default function ExamInformation() {
  return (
    <main>
      <SiteHeader activePath="/exam-information/" />
      <ArmatureSlot slug="exam-information" defaults={["exam-hero", "exam-content"]} />
      <SiteFooter />
    </main>
  );
}
