...
import { armature, stegaClean } from "@/lib/armature";
  ...
  return (
    <section className="hero" aria-labelledby="hero-title">
      ...
      <div className="wrap hero-inner">
        <h1 id="hero-title" data-armature-page-title="">
    ...
    <section className="course wrap" id="course">
      <div className="course-copy">
        ...
        <div className="mobile-inline-image">
          <img src={copy.text("course", "image")} alt={courseImageAlt} />
        </div>
  ...
  return (
    <section className="faq-section" id="inspiration">
      <div className="wrap faq-grid">
        <img className="faq-image" src={copy.text("faq", "image")} alt={faqImageAlt} />
        <div className="faq-content">
          <h2>{copy.text("faq", "heading")}</h2>
          <div className="mobile-inline-image">
            <img src={copy.text("faq", "image")} alt={faqImageAlt} />
          </div>
...
// Registered so the Armature editor can place, move, hide or wrap these sections. None is
// marked repeatable: each renders page-singleton content and carries a fixed element id
// (hero-title, #course, #exam, #inspiration), which must not appear twice on a page.
armature.registerSiteSection("hero", { label: "Hero", component: Hero });
armature.registerSiteSection("course-outline", { label: "Course outline", component: CourseOutline });
armature.registerSiteSection("faq", { label: "FAQ", component: Faq });

export default function Home() {
  return (
    <main id="top">
      <SiteHeader activePath="/" />
      {/* content/layouts/home.json lists these sections in order; without it the slot
          renders the defaults in the same order, exactly as the page did before. */}
      <ArmatureSlot slug="home" defaults={["hero", "course-outline", "faq"]} />
      <SiteFooter />
    </main>
  );
}
